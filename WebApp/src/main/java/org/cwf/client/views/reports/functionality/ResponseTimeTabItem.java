 ...
 * @author victor
 */
public class ResponseTimeTabItem extends ContentPanel implements Refreshable {
	...
	public ResponseTimeTabItem() {
		initialize();
	}

	private void initialize() {
		FieldSet responseFieldSet = new FieldSet();
		responseFieldSet.setHeading("Response Time");

 ...
 */
public class M4waterRuntimeException extends RuntimeException {
	 ...
	 */
	public M4waterRuntimeException(){}
	 ...
	 */
	public M4waterRuntimeException(String message){
		super(message);
	}
	 ...
	 */
	public M4waterRuntimeException(Throwable throwable) {
	    super(throwable);
	}
	 ...
	 */
	public M4waterRuntimeException(String message, Throwable cause) {
		super(message, cause);
	}

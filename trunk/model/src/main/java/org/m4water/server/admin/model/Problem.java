 ...
 */
public class Problem  extends AbstractEditable<Integer> {
    ...
    public Problem(int problemId, Waterpoint waterpoint, Date dateProblemReported, String problemDescsription, String problemStatus) {
        this.id = problemId;
    ...
    public Problem(int problemId, Waterpoint waterpoint, Date dateProblemReported, String problemDescsription, String problemStatus, Set problemLogs) {
       this.id = problemId;
       this.waterpoint = waterpoint;
       this.dateProblemReported = dateProblemReported;
       this.problemDescsription = problemDescsription;

...
/**
 * General class to handle M4water exceptions.
 ...
 */
public class M4waterException  extends Exception implements Serializable   {
	 ...
	 */
	public M4waterException(String message){
		super(message);
	}
	 ...
	 */
	public M4waterException(Throwable throwable) {
	    super(throwable);
	}
	 ...
	 */
	public M4waterException(String message, Throwable cause) {
		super(message, cause);
	}
}

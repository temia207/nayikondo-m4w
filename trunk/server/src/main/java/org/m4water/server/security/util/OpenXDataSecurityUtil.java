...
import org.m4water.server.admin.model.exception.UnexpectedException;
...
public class OpenXDataSecurityUtil {
	 ...
	 */
	public static void setSecurityContext(M4waterUserDetails userDetails) {
    ...
    public static User getLoggedInUser() {
        ...
        throw new M4waterSessionExpiredException("Could not find logged in user");
    }

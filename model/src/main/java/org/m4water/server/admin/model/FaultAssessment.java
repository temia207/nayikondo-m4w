 ...
 */
public class FaultAssessment  extends AbstractEditable<Integer> {
    ...
    public FaultAssessment(int id, Problem problem, String userId) {
        this.id = id;
        this.problem = problem;
        this.userId = userId;
    }
    public FaultAssessment(int id, Problem problem, String faults, Date date, String assessedBy, String typeOfRepairesNeeded, String problemFixed, String reasonNotFixed, String repairsDone, String recommendations, String userId) {
       this.id = id;
       this.problem = problem;
       this.faults = faults;
       this.date = date;

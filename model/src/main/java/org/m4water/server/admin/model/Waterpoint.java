...
public class Waterpoint extends AbstractEditable {
    ...
    public Waterpoint(int id, String referenceNumber, Date date, String district, String subcounty, String village, String latitude, String longitude, String waterSourceType, String status) {
        this.id = id;
    ...
    public Waterpoint(int id, String referenceNumber, Date date, String district, String subcounty, String village, String latitude, String longitude, String waterSourceType, String status, Set tickets) {
        this.id = id;
        this.referenceNumber = referenceNumber;
        this.date = date;
        this.district = district;
